...
public class BotaoDescontoEspecialFieldConverter extends BigDecimalConverter {
	@Override
	...
	private String buildButtonScript(EFormField field) {
		...
		sb.append(// DesPermWPH
				"<a class='btn edit_buttons' style='color: rgb(90, 112, 137); padding: 3.5px 9px; margin-left: 4px; border: 1px solid rgb(204, 204, 204); background: rgb(255, 255, 255); text-align: center; font-weight: 700; font-size: 11px; cursor: pointer; line-height: normal;' onClick='processaDescontoEspecial()'>Aplicar Desconto</a>");

		sb.append("				<script>" + "	function processaDescontoEspecial(){"
